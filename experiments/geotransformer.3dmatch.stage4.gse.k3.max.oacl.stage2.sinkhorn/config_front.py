...
_C.output_dir = osp.join(_C.root_dir, 'output_stage1_96_circle', _C.exp_name)
...
#_C.snapshot = 'code/GeoTransformer-main/output_stage1_128/geotransformer.3dmatch.stage4.gse.k3.max.oacl.stage2.sinkhorn/snapshots/epoch-15.pth.tar'
_C.snapshot = None
# train data
_C.train = edict()
...
_C.loss.weight_laplace_loss = 1.5
